...
##### Inside there are 4 tables :
    ...
    4. Invoice
##### Solution :
    [Invoice-Per-Country.sql](https://github.com/andre-ahmad/Intermediate-SQL-Certification-By-HackerRank/tree/main/invoice-percountry.sql)
...
##### There are 5 tables :
    ...
    5. Product
##### Solution :
    [Product-Sales-Per-city.sql](https://github.com/andre-ahmad/Intermediate-SQL-Certification-By-HackerRank/tree/main/produk-sales-percity.sql)
