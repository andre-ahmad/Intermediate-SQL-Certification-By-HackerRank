...
##### Inside there are 4 tables :
    ...
    4. Invoice
##### Solution :
    [Invoice-Per-Country](https://github.com/andre-ahmad/Intermediate-SQL-Certification-By-HackerRank/blob/main/invoice-percountry.sql)
...
##### There are 5 tables :
    ...
    5. Product
##### Solution :
    [Product-Sales-Per-city](https://github.com/andre-ahmad/Intermediate-SQL-Certification-By-HackerRank/blob/main/produk-sales-percity.sql)
